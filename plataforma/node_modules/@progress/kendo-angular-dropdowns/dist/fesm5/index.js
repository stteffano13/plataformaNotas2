import { ChangeDetectorRef, Component, ContentChild, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Inject, Injectable, InjectionToken, Input, KeyValueDiffers, NgModule, NgZone, Optional, Output, Renderer2, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, forwardRef, isDevMode } from '@angular/core';
...
import { partition as partition$1 } from 'rxjs/operators/partition';
...
var AutoCompleteComponent = /** @class */ (function () {
    function AutoCompleteComponent(localization, dataService, popupService, selectionService, navigationService, disabledItemsService, _zone, cdr, renderer, wrapper) {
        ...
        this.valueChangeSubject = new Subject$1();
    ...
    Object.defineProperty(AutoCompleteComponent.prototype, "data", {
        ...
        set: function (data) {
            ...
            if (this.filterable) {
                this.selectionService.focused = this.isOpen && this.data.length ? this.firstFocusableIndex(0) : -1;
            }
            var shouldSuggest = this.suggest && this.data.length && this.value;
            if (shouldSuggest) {
    ...
    AutoCompleteComponent.prototype.search = function (text, startFrom) {
        ...
        if (text.length && this.dataService.itemsCount) {
            var i = this.dataService.findIndex(this.findIndexPredicate(text), startFrom);
    ...
    AutoCompleteComponent.prototype.subscribeEvents = function () {
        ...
        this.valueChangeSubscription = this.valueChangeSubject.pipe(filter$1(function (candidate) {
        ...
        this.navigationSubscription = merge$1(this.navigationService.up, this.navigationService.down).subscribe(function (event) { return _this.navigate(event.index); });
...
var ComboBoxComponent = /** @class */ (function () {
    function ComboBoxComponent(localization, popupService, selectionService, navigationService, disabledItemsService, dataService, _zone, cdr, renderer, wrapper, touchEnabled) {
        ...
        this.valueNormalizer = function (text) {
            return text.pipe(map$1(function (userInput) { return userInput; }));
        };
        /**
        ...
        this._popupSettings = { animate: true };
        this.popupMouseDownHandler = function (event) { return event.preventDefault(); };
        this.customValueSubject = new Subject$1();
        this.valueSubject = new Subject$1();
        this.clearValueSubject = new Subject$1();
        this.selectionSubject = new Subject$1();
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "text", {
        ...
        set: function (text) {
            var textCandidate = this.prop(this.textField, true)(text);
    ...
    ComboBoxComponent.prototype.createValueStream = function () {
        ...
        var valueStream = this.valueSubject.pipe(filter$1(function (candidate) {
        ...
        var customValueStreams = partition$1(function () { return _this.allowCustom; })(this.customValueSubject.pipe(throttleTime$1(300)));
        var allowCustomValueStream = customValueStreams[0].pipe(tap$1(function () {
            _this.loading = true;
            _this.disabled = true;
            _this.cdr.detectChanges();
        }), filter$1(function () {
            ...
            return hasChange;
        }), this.valueNormalizer, map$1(function (normalizedValue) {
            return {
                custom: true,
        ...
        var disableCustomValueStream = customValueStreams[1].pipe(map$1(function () {
            return {
                custom: true,
                dataItem: undefined,
                text: undefined,
        ...
        var clearValueStream = this.clearValueSubject.pipe(map$1(function () { return ({
            dataItem: undefined,
            text: undefined,
            value: undefined
        }); }));
        ...
        var merged = merge$1(valueStream, allowCustomValueStream, disableCustomValueStream, clearValueStream);
        this.valueSubscription = merged.pipe(catchError$1(function () {
    ...
    ComboBoxComponent.prototype.attachStreams = function () {
        ...
        this.subs.add(merge$1(this.navigationService.up, this.navigationService.down, this.navigationService.home, this.navigationService.end)
            .pipe(filter$1(function (event) { return isPresent(event.index); }))
        ...
        this.subs.add(this.navigationService.enter.pipe(tap$1(function (event) {
            if (_this.isOpen) {
                event.originalEvent.preventDefault();
            }
        }))
            .subscribe(this.handleEnter.bind(this)));
        this.subs.add(this.selectionSubject.pipe(distinctUntilChanged$1()).subscribe(function (dataItem) {
            _this.selectionChange.emit(dataItem);
        }));
        this.subs.add(merge$1(this.selectionService.onChange, this.selectionService.onSelect.pipe(filter$1(function (_) { return !_this.isOpen; })))
            .pipe(tap$1(function (_) {
            _this._filtering = false;
            _this.togglePopup(false);
        }), map$1(function (event) { return _this.dataService.itemAt(event.indices[0]); }))
            .subscribe(function (dataItem) {
            _this.change(dataItem);
        }));
        this.subs.add(this.selectionService.onSelect.pipe(filter$1(function (_) { return _this.isOpen; }), tap$1(function (_) { return _this._filtering = false; }), map$1(function (event) { return _this.dataService.itemAt(event.indices[0]); }))
            .subscribe(function (dataItem) {
    ...
    ComboBoxComponent.prototype.navigate = function (index) {
        ...
        this.text = this.dataService.itemAt(index);
...
var DropDownListComponent = /** @class */ (function () {
    function DropDownListComponent(localization, popupService, selectionService, navigationService, disabledItemsService, dataService, _zone, renderer, hostElement, cdr, touchEnabled) {
        ...
        this.selectionSubscription = new Subscription$1();
        this._open = false;
        this._popupSettings = { animate: true };
        this.direction = localization.rtl ? 'rtl' : 'ltr';
        this.data = [];
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.selectionSubscription.add(this.selectionService.onSelect.pipe(filter$1(function (_) { return _this.isOpen; }), map$1(this.itemFromEvent.bind(this)))
            .subscribe(this.onSelectionChange.bind(this)));
        // item selection when the popup is closed | clicked | enter, etc.
        this.selectionSubscription.add(merge$1(this.selectionService.onSelect.pipe(filter$1(function (_) { return !_this.isOpen; })), this.selectionService.onChange).pipe(map$1(this.itemFromEvent.bind(this)), tap$1(function (_) { return _this.togglePopup(false); }))
            .subscribe(function (_a) {
        ...
        this.navigationSubscription = merge$1(this.navigationService.up, this.navigationService.down, this.navigationService.left.pipe(skipWhile$1(function () { return _this.filterable; })), this.navigationService.right.pipe(skipWhile$1(function () { return _this.filterable; })), this.navigationService.home, this.navigationService.end)
            .pipe(filter$1(function (event) { return !isNaN(event.index); }))
        ...
        this.filterBlurredSubscription = this.filterBlurred.pipe(concatMap$1(function () { return interval$1(10).pipe(take$1(1), takeUntil$1(_this.wrapperFocused)); }))
            .subscribe(function () {
            _this.wrapperBlurred.emit();
        });
        this._zone.runOutsideAngular(function () {
            _this.componentBlurredSubscription =
                merge$1(_this.wrapperBlurred.pipe(concatMap$1(function () { return interval$1(10).pipe(take$1(1), takeUntil$1(_this.filterFocused)); })), _this.navigationService.tab).pipe(tap$1(function (event) { return event instanceof NavigationEvent && _this.focus(); }), filter$1(function () { return _this.isFocused; }))
...
var MultiSelectComponent = /** @class */ (function () {
    function MultiSelectComponent(localization, popupService, dataService, selectionService, navigationService, disabledItemsService, cdr, differs, renderer, hostElement, _zone, touchEnabled) {
         ...
         * ```
         */
        this.valueNormalizer = function (text) { return text.pipe(map$1(function (userInput) {
        ...
        this.customValueSubject = new Subject$1();
        this.observableSubscriptions = new Subscription$1();
        this.hostElement = hostElement.nativeElement;
        this.popupMouseDownHandler = this.onMouseDown.bind(this);
        this.data = [];
    ...
    MultiSelectComponent.prototype.subscribeEvents = function () {
        ...
        [
            ...
            this.navigationService.enter.pipe(filter$1(isOpen)).subscribe(this.handleEnter.bind(this)),
            ...
            this.navigationService.up.pipe(filter$1(isOpen)).subscribe(function (event) { return _this.handleUp(event.index); }),
            this.navigationService.home.pipe(filter$1(function () { return isClosed; })).subscribe(this.handleHome.bind(this)),
            this.navigationService.end.pipe(filter$1(function () { return isClosed; })).subscribe(this.handleEnd.bind(this)),
            this.navigationService.backspace.pipe(filter$1(isTagFocused)).subscribe(this.handleBackspace.bind(this)),
            this.navigationService.delete.pipe(filter$1(isTagFocused)).subscribe(this.handleDelete.bind(this)),
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        dataItems
            ...
            var filter$$1 = function (item) { return prop(item) !== prop(dataItem); };
            _this.value = _this.value.filter(filter$$1);
            _this.selectedDataItems = _this.selectedDataItems.filter(filter$$1);
        });
        this.tags = this.tagMapper(this.selectedDataItems.slice(0));
        this.cdr.markForCheck();
        this.emitValueChange();
    ...
    MultiSelectComponent.prototype.createCustomValueStream = function () {
        ...
        this.customValueSubscription = this.customValueSubject.pipe(tap$1(function () {
            _this.loading = true;
            _this.disabled = true;
            _this.cdr.detectChanges();
        }), this.valueNormalizer, catchError$1(function () {
            _this.loading = false;
            _this.disabled = false;
            _this.clearFilter();
            if (_this.autoClose) {
    ...
    MultiSelectComponent.prototype.findIndex = function (text, startsFrom) {
        ...
        index = (index === -1) ? -1 : index + startsFrom;
        if (this.disabledItemsService.isIndexDisabled(index)) {
...
var ListItemDirective = /** @class */ (function () {
    ...
    ListItemDirective.decorators = [
        { type: Directive, args: [{
                    selector: 'li[role=option]' // tslint:disable-line
                },] },
    ];
    /** @nocollapse */
...
var ListComponent = /** @class */ (function () {
    ...
    function ListComponent(wrapper, dataService, selectionService, disabledItemsService) {
        ...
        this.selectSubscription = this.selectionService
            .onSelect.pipe(map$1(function (args) { return args.indices[0]; }), merge$3(this.selectionService.onFocus))
    ...
    ListComponent.prototype.ngAfterViewInit = function () {
        if (this.show === true) {
            if (this.dataService.grouped) {
                ...
                this.scrollSubscription = fromEvent$1(this.content.nativeElement, "scroll")
