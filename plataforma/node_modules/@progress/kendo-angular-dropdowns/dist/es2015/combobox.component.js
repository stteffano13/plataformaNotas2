...
import { isPresent, isChanged, guid, isDocumentAvailable, getter, isObject } from './util';
...
export class ComboBoxComponent {
    ...
    attachStreams() {
        ...
        this.subs.add(this.selectionSubject.pipe(distinctUntilChanged()).subscribe((dataItem) => {
