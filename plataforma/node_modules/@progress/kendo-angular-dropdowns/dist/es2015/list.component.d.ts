...
export declare class ListComponent {
    ...
    constructor(wrapper: ElementRef, dataService: DataService, selectionService: SelectionService, disabledItemsService: DisabledItemsService);
    /**
     * @hidden
     */
    firstVisibleItem(items: Array<any>): any;
